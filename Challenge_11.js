...
export default function shouldBuyFidelity(times) {
   let resultFidelity = 0, reulstTicket= 0;
   for(let i = 1; i<=times; i++){
     resultFidelity += Math.pow(0.75, i);
   }
   resultFidelity = 250 + 12*(resultFidelity);
   reulstTicket = times *12;
   return resultFidelity < reulstTicket?true:false
 }